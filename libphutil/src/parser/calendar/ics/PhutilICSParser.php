...
final class PhutilICSParser extends Phobject
{
    ...
    /**
     * @param $data
     * @return PhutilCalendarDocumentNode|PhutilCalendarEventNode|PhutilCalendarRawNode|PhutilCalendarRootNode
     * @author 陈妙威
     */
    ...
    /**
     * @param PhutilCalendarEventNode $node
     * @param $name
     * @param array $parameters
     * @param array $value
     * @author 陈妙威
    ...
    private function newAttendeeFromProperty(array $parameters, array $value)
    {
        ...
        return (new PhutilCalendarUserNode())
            ->setURI($uri)
            ->setName($name)
            ->setStatus($status);
    }
