 ...
 */
final class OranginsPhutilLibraryMapBuilder extends \Phobject
{
     ...
     * @return PhutilLibraryMapBuilder
     *
     * @task map
     */
     ...
     * @throws XHPASTSyntaxErrorException
     * @task map
     */
     ...
     *
     * @param  array  Symbol map of relative paths to symbols.
     * @param  array  Source map (like @{method:loadSourceFileMap}).
     * @return void
     *
     * @task symbol
     */
    ...
    private function buildSymbolAnalysisFuture($file)
    {
        ...
        $bin = __DIR__ . '/phutil_symbols.php';
