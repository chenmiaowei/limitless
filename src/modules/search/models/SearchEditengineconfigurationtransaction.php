...
/**
 * This is the model class for table "search_editengineconfigurationtransaction".
 *
 * @property int $id
 ...
 */
class SearchEditengineconfigurationtransaction extends \orangins\lib\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
