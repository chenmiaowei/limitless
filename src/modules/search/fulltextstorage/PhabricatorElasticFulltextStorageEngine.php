...
use HTTPFutureResponseStatus;
use HTTPSFuture;
use orangins\lib\infrastructure\cluster\search\PhabricatorElasticsearchHost;
    ...
    extends PhabricatorFulltextStorageEngine
{
     ...
     * @return $this|PhabricatorFulltextStorageEngine
     * @author 陈妙威
     */
    ...
    /**
     * @return PhabricatorElasticsearchHost|\orangins\lib\infrastructure\cluster\search\PhabricatorSearchHost
     * @author 陈妙威
     */
    ...
    /**
     * @return \orangins\lib\infrastructure\cluster\search\PhabricatorSearchHost
    ...
    /**
     * @param PhabricatorElasticsearchHost|null $host
     * @return bool
     * @throws HTTPFutureHTTPResponseStatus
     * @throws HTTPFutureResponseStatus
     * @throws PhutilProxyException
     * @throws \orangins\lib\infrastructure\cluster\exception\PhabricatorClusterNoHostForRoleException
     * @author 陈妙威
    ...
    private function getIndexConfiguration()
    {
        ...
        $doc_types = array_keys(PhabricatorSearchApplicationSearchEngine::getIndexableDocumentTypes());
    ...
    /**
     * @param PhabricatorElasticsearchHost $host
     * @param $path
     * @param array $data
     * @param string $method
