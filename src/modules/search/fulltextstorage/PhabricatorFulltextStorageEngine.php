...
use orangins\lib\infrastructure\cluster\search\PhabricatorSearchHost;
 ...
 */
abstract class PhabricatorFulltextStorageEngine extends OranginsObject
{

    /**
     * @var PhabricatorSearchService
     */
    protected $service;
     ...
     * @return array A list of matching PHIDs.
     */
