...
/**
 * Class PhabricatorProfileMenuItemViewList
    ...
    extends OranginsObject
{
    ...
    /**
     * @var PhabricatorProfileMenuEngine
     */
    private $engine;
    /**
     * @var array
    ...
    /**
     * @param PhabricatorProfileMenuItemView $view
     * @return $this
     * @author 陈妙威
     */
    ...
    public function setSelectedViewWithItemIdentifier($identifier)
    {
        ...
        /** @var PhabricatorProfileMenuItemView $view */
        $view = head($views);
    ...
    public function newNavigationView()
    {
        ...
        $navigation = (new AphrontSideNavFilterView())
        ...
        if (!$views) {
            ...
            $empty_item = (new PHUIListItemView())
    ...
    /**
     * @param array $items
     * @param PHUIListItemView|null $selected_item
     * @return null
     * @throws \Exception
     * @author 陈妙威
     */
        ...
        PHUIListItemView $selected_item = null)
    {
        ...
        assert_instances_of($items, PHUIListItemView::className());
    ...
    private function isMatchForRequestURI(AphrontRequest $request, $item_uri)
    {
        ...
        $production_domain = (new PhutilURI($production_uri))
            ->getDomain();
