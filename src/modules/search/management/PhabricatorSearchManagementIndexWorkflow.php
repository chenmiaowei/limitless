...
/**
 * Class PhabricatorSearchManagementIndexWorkflow
    ...
    extends PhabricatorSearchManagementWorkflow
{
    ...
    public function execute(PhutilArgumentParser $args)
    {
        ...
        $groups = PhabricatorPHID::phid_group_by_type($phids);
    ...
    {
        return PhabricatorSearchIndexVersion::find()
            ->select(['extension_key', 'version'])
            ->andWhere([
                'object_phid' => $phid
            ])
            ->orderBy("extension_key, version")
            ->all();
//        return queryfx_all(
//            $conn,
