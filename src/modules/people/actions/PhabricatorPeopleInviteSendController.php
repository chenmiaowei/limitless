...
use orangins\modules\auth\data\PhabricatorAuthInviteAction;
use orangins\modules\auth\view\PhabricatorAuthInviteActionTableView;
use orangins\modules\people\capability\PeopleCreateUsersCapability;

/**
 * Class PhabricatorPeopleInviteSendController
    ...
    public function run()
    {
        ...
        if ($request->isFormPost()) {
            ...
            if (!$errors) {
                ...
                /** @var PhabricatorAuthInviteAction $actions */
