 ...
 * @author 陈妙威
 */
final class PhabricatorDashboardPanelChartPieDatasource extends PhabricatorTypeaheadDatasource
{
    ...
    {
        $allEngines = PhabricatorDashboardPanelChartPieDataSourceEngine::getAllEngines();
    ...
    private function buildResults() {
        $types = PhabricatorDashboardPanelChartPieDataSourceEngine::getAllEngines();
        $results = array();
