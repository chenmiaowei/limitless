 ...
 * @author 陈妙威
 */
final class PhabricatorDashboardPanelChartLineDatasource extends PhabricatorTypeaheadDatasource
{
    ...
    {
        $allEngines = PhabricatorDashboardPanelChartLineDataSourceEngine::getAllEngines();
    ...
    private function buildResults() {
        $types = PhabricatorDashboardPanelChartLineDataSourceEngine::getAllEngines();
        $results = array();
