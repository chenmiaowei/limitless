 ...
 * @author 陈妙威
 */
final class PhabricatorDashboardChartPiePanelEditField
    extends PhabricatorEditField
{
     ...
     * @param $getControlID
     * @author 陈妙威
     * @return PhabricatorDashboardChartPiePanelEditField
     */
    ...
    protected function newControl()
    {
        ...
        return (new AphrontFormTokenizerControl())
            ->setDatasource(new PhabricatorDashboardPanelChartPieDatasource())
            ->setLimit(1)
