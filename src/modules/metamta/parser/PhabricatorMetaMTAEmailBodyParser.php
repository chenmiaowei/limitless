...
namespace orangins\modules\metamta\parser;

use orangins\lib\OranginsObject;

/**
 * Class PhabricatorMetaMTAEmailBodyParser
 * @package orangins\modules\metamta\parser
 * @author 陈妙威
 */
final class PhabricatorMetaMTAEmailBodyParser extends OranginsObject
{
