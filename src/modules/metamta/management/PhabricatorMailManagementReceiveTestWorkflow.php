...
/**
 * Class PhabricatorMailManagementReceiveTestWorkflow
    ...
    extends PhabricatorMailManagementWorkflow
{
    ...
    public function execute(PhutilArgumentParser $args)
    {
        ...
        $to_application_email = PhabricatorMetaMTAApplicationEmail::find()
        ...
        if (!$as && $to_application_email) {
            ...
            if ($default_phid) {
                $default_user = PhabricatorUser::find()
                    ->setViewer($this->getViewer())
        ...
        if (preg_match('/.+@.+/', $to)) {
            ...
            $pseudomail = (new PhabricatorMetaMTAReceivedMail())
                ->setHeaders(
                    array(
                        'to' => $raw_target,
                    ));
