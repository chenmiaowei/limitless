 ...
 */
final class PhabricatorMetaMTAMemberQuery extends PhabricatorBaseQuery
{
...
//        $package_phids = ArrayHelper::getValue($type_map, $package_type, array());
//        unset($type_map[$package_type]);
//
//        $package_map = array();
//        if ($package_phids) {
//            $packages = (new PhabricatorOwnersPackageQuery())
//                ->setViewer($viewer)
...
//                    $resolved_phids = ArrayHelper::getValue($results, $owner_phid, array());
