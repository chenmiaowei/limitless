...
use orangins\modules\metamta\message\PhabricatorMailHeader;
...
/**
 * Class PhabricatorMailEmailEngine
    ...
    extends PhabricatorMailMessageEngine
{
    ...
    /**
     * @return PhabricatorMailEmailMessage|null
    ...
    /**
     * @return PhutilEmailAddress|null
     * @author 陈妙威
     */
    ...
    {
        return (new PhabricatorMailHeader())
            ->setName($name)
            ->setValue($value);
    }
