...
use orangins\modules\cache\PhabricatorKeyValueDatabaseCache;
...
use orangins\modules\config\view\PhabricatorSetupIssueView;
use PhutilClassMapQuery;
use Exception;

/**
 * Class PhabricatorSetupCheck
 * @package orangins\modules\config\check
 * @author 陈妙威
 */
abstract class PhabricatorSetupCheck extends OranginsObject
{
    ...
    public static function newIssueResponse(PhabricatorSetupIssue $issue)
    {
        ...
        return (new PhabricatorConfigResponse())
            ->setView($view);
    }
