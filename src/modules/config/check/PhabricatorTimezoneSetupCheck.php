...
final class PhabricatorTimezoneSetupCheck extends PhabricatorSetupCheck {
  ...
  protected function executeChecks() {
    ...
    if ($php_value) {
      ...
      if (!$ok) {
        ...
        $this
          ...
          ->setShortName(\Yii::t("app",'PHP Timezone'))
          ->setName(\Yii::t("app",'PHP Timezone Invalid'))
          ->setMessage($message)
    ...
    $this
      ...
      ->setShortName(\Yii::t("app",'Timezone'))
      ->setName(\Yii::t("app",'Server Timezone Not Configured'))
      ->setSummary($summary)
      ->setMessage($message)
      ->addPHPConfig('date.timezone')
