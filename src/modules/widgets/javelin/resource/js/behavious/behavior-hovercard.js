...
/** @namespace JX.Hovercard */
/** @namespace JX.Stratcom */
/** @namespace JX.Device */
/** @namespace JX.Vector */
...
JX.behavior('phui-hovercards', function () {
    ...
    // 需要监听 mousemove 事件， 必须enableDispatch('mousemove')
    JX.enableDispatch(document.body, 'mousemove');

    JX.Stratcom.listen('mousemove', 'hovercard', function (e) {
        ...
        JX.Hovercard.show(e.getNode('hovercard'), data['hoverPHID']);
    });
