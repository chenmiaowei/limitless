...
class PhabricatorUserServiceAmountTransaction  extends PhabricatorUserServiceTransactionType
{
    /**
     *
     */
    const TRANSACTIONTYPE = 'userservice:amount';
    ...
    {
        return $object->getAttribute("amount");
    }
    ...
    {
        $object->setAttribute("amount", $value);
    }
