...
use orangins\modules\oauthserver\models\PhabricatorOAuthServerAuthorizationCode;
 ...
 */
final class PhabricatorOAuthServer extends OranginsObject
{
     ...
     * @task auth
     * @param array $scope
     * @return array <bool hasAuthorized, ClientAuthorization or null>
     * @throws PhutilInvalidStateException
     */
    public function userHasAuthorizedClient(array $scope)
    {
        ...
        $authorization  = PhabricatorOAuthClientAuthorization::find()
            ->andWhere([
                ...
                'client_phid' => $this->getClient()->getPHID()
            ])->one();
     ...
     * @task auth
     * @param array $scope
     * @return PhabricatorOAuthClientAuthorization
     * @throws PhutilInvalidStateException
    ...
    /**
     * @task auth
     * @param PhutilURI $redirect_uri
     * @return PhabricatorOAuthServerAuthorizationCode
     * @throws PhutilInvalidStateException
     * @throws \AphrontQueryException
     * @throws \yii\db\IntegrityException
     */
    ...
    /**
     * @task token
     * @return PhabricatorOAuthServerAccessToken
     * @throws PhutilInvalidStateException
     * @throws \AphrontQueryException
     * @throws \yii\db\IntegrityException
     */
    ...
    /**
     * @task token
     * @param PhabricatorOAuthServerAuthorizationCode $test_code
     * @param PhabricatorOAuthServerAuthorizationCode $valid_code
     * @return bool
     */
        ...
        PhabricatorOAuthServerAuthorizationCode $valid_code)
    {
        ...
        $created_time = $test_code->created_at;
    ...
    /**
     * @task token
     * @param PhabricatorOAuthServerAccessToken $token
     * @return null
     * @throws \Exception
     */
     ...
     * @param PhutilURI $secondary_uri
     * @param PhutilURI $primary_uri
     * @return bool
     * @throws Exception
     */
