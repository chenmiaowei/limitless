...
use PhutilAPCKeyValueCache;
use PhutilInRequestKeyValueCache;
use PhutilKeyValueCacheNamespace;
use PhutilKeyValueCacheProfiler;
use PhutilKeyValueCacheStack;
use PhutilOnDiskKeyValueCache;
use Exception;
 ...
 */
final class PhabricatorCaches extends OranginsObject
{
    ...
    {
        return PhabricatorEnv::getEnvConfig('orangins.cache-namespace');
    }

    /**
     * @param array $caches
     * @return PhutilKeyValueCacheStack
     * @throws Exception
     * @author 陈妙威
     */
    private static function newStackFromCaches(array $caches)
    {
        ...
        /** @var PhutilKeyValueCacheStack $setCaches */
        $setCaches = (new PhutilKeyValueCacheStack())
            ->setCaches($caches);
        return $setCaches;
    }
     ...
     * not.
     *
     * @return PhutilInRequestKeyValueCache Request cache stack.
     */
     ...
     *
     * @return array<PhutilKeyValueCache> List of caches.
     * @task immutable
     */
     ...
     *
     * @return PhutilKeyValueCacheStack|\this
     * @task setup
     */
    ...
    public static function inflateData($value)
    {
        ...
        if ($value === false) {
            throw new Exception(\Yii::t("app", 'Failed to inflate data!'));
        }
