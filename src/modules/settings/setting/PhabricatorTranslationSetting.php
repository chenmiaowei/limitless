...
/**
 * Class PhabricatorTranslationSetting
    ...
    extends PhabricatorOptionGroupSetting
{
    ...
    protected function getSelectOptionGroups()
    {
        ...
        $group_labels = array(
            'normal' => \Yii::t("app",'Translations'),
            'limited' => \Yii::t("app",'Limited Translations'),
            'silly' => \Yii::t("app",'Silly Translations'),
            'test' => \Yii::t("app",'Developer/Test Translations'),
        );
