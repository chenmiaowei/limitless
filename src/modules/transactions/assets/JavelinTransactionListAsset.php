 ...
 * @author 陈妙威
 */
class JavelinTransactionListAsset extends JavelinBehaviorAsset
{
    /**
     * @return string
     * @author 陈妙威
    ...
    {
        return 'phabricator-transaction-list';
    }
     ...
     */
    public $js = [
        'js/behavior-transaction-list.js',
    ];

    public $css = [
        'css/phui-timeline-view.css',
    ];
