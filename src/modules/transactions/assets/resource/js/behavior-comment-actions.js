...
JX.behavior('comment-actions', function (config) {
    ...
    var action_node = $('#' + config.actionID);
    var form_node = $('#' + config.formID);
    var input_node = $('#' + config.inputID);
    var place_node = $('#' + config.placeID);

    var rows = {};

    $(document).on('change', action_node, function () {
    ...
    $(document).on('submit didSyntheticSubmit', form_node, function () {
