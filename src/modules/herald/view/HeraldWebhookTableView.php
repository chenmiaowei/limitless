...
/**
 * Class HeraldWebhookTableView
 * @package orangins\modules\herald\view
 * @author 陈妙威
 */
final class HeraldWebhookTableView extends AphrontView
{
    ...
    public function render()
    {
            ...
            $rows[] = array(
                ...
                [
                    (new PHUIButtonView())
                        ...
                        ->setHref(Url::to(['/herald/webhook/edit'
                            , 'id' => $item->getID()
                    ...
                    (new PHUIButtonView())
                        ...
                        ->setSize("btn-xs")
                        ->setColor(PhabricatorEnv::getEnvConfig("ui.widget-color"))
                        ->setHref(Url::to(['/herald/webhook/view'
                            , 'id' => $item->getID()
                            , 'redirect_uri' => Yii::$app->request->url
                        ]))
                ]
        ...
        $table->setHeaders(
            array(
                ...
                // Yii::t("app",'Phid'),
                Yii::t("app",'Name'),
                Yii::t("app",'Webhook Uri'),
                Yii::t("app",'View Policy'),
                Yii::t("app",'Edit Policy'),
                Yii::t("app",'Status'),
                Yii::t("app",'Hmac Key'),
