...
namespace orangins\modules\herald\worker;

use orangins\lib\infrastructure\daemon\workers\PhabricatorWorker;
use orangins\modules\people\models\PhabricatorUser;

/**
 * Class HeraldWebhookWorker
 * @package orangins\modules\herald\worker
 * @author 陈妙威
 */
    ...
    extends PhabricatorWorker
{
    ...
    protected function doWork()
    {
        ...
        $request = (new HeraldWebhookRequestQuery())
            ->setViewer($viewer)
     ...
     * @param HeraldWebhookRequest $request
     * @param $object
        ...
        array $xactions)
    {
        ...
        $payload = (new PhutilJSON())->encodeFormatted($payload);
        $key = $hook->getHmacKey();
