    ...
    extends PhabricatorFileStorageFormat
{
    ...
    {
        return \Yii::t("app",'Encrypted (AES-256-CBC)');
    }
    ...
    /**
     * @param PhutilOpaqueEnvelope $key_envelope
     * @param PhutilOpaqueEnvelope $iv_envelope
     * @return array
     * @author 陈妙威
     * @throws Exception
     */
    ...
    /**
     * @param $data
     * @param PhutilOpaqueEnvelope $key
     * @param PhutilOpaqueEnvelope $iv
     * @return string
     * @author 陈妙威
     */
