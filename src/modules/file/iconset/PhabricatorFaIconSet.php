 ...
 * @author 陈妙威
 */
final class PhabricatorFaIconSet extends PhabricatorIconSet
{
    ...
    {
        return Yii::t("app", 'Choose Fa Icon');
    }
    ...
    public static function getRandomIcon() {
        $iconSpecifications = self::getIconSpecifications();
        $var = $iconSpecifications[rand(0, count($iconSpecifications) - 1)];

        return (new PhabricatorIconSetIcon())
            ->setKey($var)
            ->setIcon($var)
            ->setLabel($var);
    }
     ...
     * @author 陈妙威
     */
    public static function getIconSpecifications()
    {
        return array(
            "fa-lg",
            "fa-2x",
