...
/**
 * This is the model class for table "file_macro_transaction".
 *
 * @property int $id
 ...
 */
class FileMacroTransaction extends PhabricatorApplicationTransaction
{
    /**
     * {@inheritdoc}
     */
