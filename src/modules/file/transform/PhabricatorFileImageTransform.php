...
abstract class PhabricatorFileImageTransform extends PhabricatorFileTransform
{
     ...
     * @return array<int, int>|null Width and height, if available.
     */
    ...
    protected function newEmptyImage($w, $h)
    {
        ...
        if (($w <= 0) || ($h <= 0)) {
            throw new Exception(
                \Yii::t("app",'Can not create an image with nonpositive dimensions.'));
        }
     ...
     *
     * @return array<int, int> Width and height of the image.
     * @throws Exception
     * @throws \FilesystemException
     * @throws \ReflectionException
     */
