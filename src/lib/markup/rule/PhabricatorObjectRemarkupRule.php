...
/**
 * Class PhabricatorObjectRemarkupRule
...
abstract class PhabricatorObjectRemarkupRule extends PhutilRemarkupRule
{
    ...
    protected function renderHovertag($name, $href, array $attr = array())
    {
        return (new PHUITagView())
            ...
            ->setPHID(ArrayHelper::getValue($attr, 'phid'))
            ->setClosed(ArrayHelper::getValue($attr, 'closed'))
            ->render();
    }
    ...
    public function markupObjectEmbed(array $matches)
    {
        ...
        return $this->markupObject(array(
            'type' => 'embed',
            'id' => $matches[1],
            'options' => ArrayHelper::getValue($matches, 2),
            'original' => $matches[0],
        ));
    }
    ...
    public function markupObjectReference(array $matches)
    {
        ...
        return $this->markupObject(array(
            'type' => 'ref',
            'id' => $matches[1],
            'anchor' => ArrayHelper::getValue($matches, 2),
            'original' => $matches[0],
        ));
    }
