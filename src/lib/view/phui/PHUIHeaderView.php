 ...
 * @author 陈妙威
 */
class PHUIHeaderView extends AphrontTagView
{
    /**
     *
     */
...
//        require_celerity_resource('phui-header-view-css');
        ...
        $classes = array();
        $classes[] = 'header-elements-inline';
    ...
    protected function getTagContent()
    {
        ...
        if ($this->actionLinks) {
            ...
            foreach ($this->actionLinks as $button) {
                if (!$button->getColor()) {
                    $button->setColor(PHUIButtonView::COLOR_GREY_300);
                }
    ...
    private function renderPolicyProperty(PhabricatorPolicyInterface $object)
    {
        ...
        if (!$use_space_policy) {
            ...
            if ($object instanceof PhabricatorPolicyCodexInterface) {
                $phabricatorPolicyCodex = PhabricatorPolicyCodex::newFromObject($object, $viewer);
                $codex = $phabricatorPolicyCodex
