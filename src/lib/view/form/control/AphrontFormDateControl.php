...
final class AphrontFormDateControl extends AphrontFormControl
{
    ...
    protected function renderInput()
    {
        ...
        $date_div = JavelinHtml::phutil_tag(
            'div',
            array(
        ...
        $cicon = (new PHUIIconView())
            ->addClass('ml-2 mr-2')
            ->setIcon('fa-calendar');

        $cal_icon = JavelinHtml::phutil_tag(
            'a',
            array(
                'href' => '#',
        ...
        $time_id = JavelinHtml::generateUniqueNodeId();
        JavelinHtml::initBehavior(new JavelinTimeTypeaheadBehaviorAsset(), array(
            'startTimeID' => $time_id,
        ...
        $time_sel = JavelinHtml::phutil_tag(
            'input',
            array(
                'autocomplete' => 'off',
        ...
        $time_div = JavelinHtml::phutil_tag(
            'div',
            array(
                'id' => $time_id,
        ...
        JavelinHtml::initBehavior(new JavelinFancyDatepickerBehaviorAsset(), array(
