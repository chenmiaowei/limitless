...
use orangins\lib\infrastructure\query\PhabricatorOffsetPagedQuery;
...
abstract class PhabricatorPolicyAwareQuery extends PhabricatorOffsetPagedQuery
{
    ...
    /**
     * @return PhabricatorPolicyFilter
     * @author 陈妙威
     */
     ...
     *
     * @return array<phid, phid> Map of object PHIDs which were filtered
     *   by policies.
     * @task exec
     */
     ...
     * filtering.
     *
     * @param array<phid, PhabricatorPolicyInterface> Objects to add to the query
     *   workspace.
     * @return static
     * @task workspace
     * @throws Exception
     ...
     *
     * @return array<phid, phid> PHIDs currently in flight.
     */
     ...
     *
     * @param array<wild>  List of objects that should not be returned by alternate
     *                    result mechanisms.
     * @return void
     * @task policyimpl
     */
    ...
    private function applyWillFilterPageExtensions(array $page)
    {
        ...
        if ($bridges) {
            ...
            if ($external_phids) {
                $external_objects = (new  DoorkeeperExternalObjectQuery())
