...
final class PhabricatorSlug extends OranginsObject {
  ...
  public static function normalize($slug, $hashtag = false) {
    ...
    // NOTE: These are explicitly not \Yii::t("app",)'d, because they should be stable
    // across languages.
  ...
  public static function getDefaultTitle($slug) {
    ...
    $default_title = nonempty($default_title, \Yii::t("app",'Untitled Document'));
