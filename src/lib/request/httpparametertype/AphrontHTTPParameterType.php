 ...
 */
abstract class AphrontHTTPParameterType extends OranginsObject
{
     ...
     * @return AphrontHTTPParameterType
     * @task read
     */
     ...
     * @param AphrontRequest $request The incoming request.
     * @param string The key to examine.
     * @return array Value, or default if value is not present.
     * @task read
     */
     ...
     *
     * @return array Default value for this type.
     * @task read
     */
     ...
     * documentation.
     *
     * @return array<string> Human-readable list of acceptable formats.
     * @task info
     */
     ...
     *
     * @return array<string> Human-readable list of format examples.
     * @task info
     */
     ...
     * @task util
     */
    final protected function getExistsWithType(AphrontHTTPParameterType $type, AphrontRequest $request, $key)
    {
     ...
     * @task util
     */
    final protected function getValueWithType(AphrontHTTPParameterType $type, AphrontRequest $request, $key)
    {
     ...
     *
     * @return AphrontHTTPParameterType[] List of all available types.
     * @task util
     */
